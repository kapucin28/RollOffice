...
public class MainTable2 extends Pane implements Scale {
    ...
    private final TableColumn<Table2, String> postColumn = new TableColumn<>(TableColumnsTextLink.Post.toString());
    private final TableColumn<Table2, Long> scrapColumn = new TableColumn<>(TableColumnsTextLink.Scrap.toString());
    private final TableColumn<Table2, Long> pendingColumn = new TableColumn<>(TableColumnsTextLink.Pending.toString());
    private final TableColumn<Table2, Long> outputColumn = new TableColumn<>(TableColumnsTextLink.Output.toString());
    private final TableColumn<Table2, Long> targetColumn = new TableColumn<>(TableColumnsTextLink.Target.toString());
    private final TableColumn<Table2, Long> monthColumn = new TableColumn<>(TableColumnsTextLink.Month.toString());
    private final TableColumn<Table2, Long> yearColumn = new TableColumn<>(TableColumnsTextLink.Year.toString());
